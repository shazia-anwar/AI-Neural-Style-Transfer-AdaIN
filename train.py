...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='E:/AI And ML/Major Projects/Neural Style Transfer With AdaIN/Neural Style Transfer/content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='E:/AI And ML/Major Projects/Neural Style Transfer With AdaIN/Neural Style Transfer/style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='E:/AI And ML/Major Projects/Neural Style Transfer With AdaIN/Neural Style Transfer/vgg_normalised.pth',
